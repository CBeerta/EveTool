<div id="content">
<h2 class="title">Agents for <?php echo $character; ?></h2>
<br />
<div>
    <div style="top: 0px; right: 0px; float: right;">
        <table>
        <caption>Filter Options</caption>
        <?php echo form_open("/characters/agentfinder/{$character}"); ?>
        <tr>
            <td id="left">
                Only Usable:<br />
        ...
        <tr>
            <td><a href="<?php echo site_url("/characters/agentfinder/{$character}/{$corpid}"); ?>">Reset Filter</a></td>
    ...
    <div style="float: left;">
        ...
        <?php foreach ($agents as $row): ?>
            ...
            <?php echo Agents::agent_snippet($row->itemID, isset($corpstanding) ? $corpstanding : False); ?>
        <?php endforeach; ?>    
        <?php else: ?>
